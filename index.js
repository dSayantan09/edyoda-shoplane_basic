var productList = [
  ...
  var temp_clothing_container = document.createElement('div');
  temp_clothing_container.classList.add('row', 'position', 'contain');
  
  var temp_accessories_container = document.createElement('div');
  temp_accessories_container.classList.add('row', 'position', 'contain');
  ...
  document.getElementById('box1').appendChild(temp_clothing_container);
  document.getElementById('box2').appendChild(temp_accessories_container);